...
class ImageHelper
{
    public function __construct()
    {
        ...
        $this->save_directory  =  "/var/www/html/whereswaldo2/images/saved/";
    }
...
if ($argv[1] == 'run_image_tests') {
    ...
    $waldoImg = $waldoGame->resize_waldo('waldo_walking_200x451.png', 16, 32, 'waldo_resized', '/var/www/html/whereswaldo2/scripts/test_output');

    // put a single waldo on another image
    $waldoGame->place_waldo('/var/www/html/whereswaldo2/images/crowd.jpg', $waldoImg, 16, 32, 100, 100, 'single_waldo_on_background', '/var/www/html/whereswaldo2/scripts/test_output');
    ...
    $base = '/var/www/html/whereswaldo2/images/crowd.jpg';
    $max = 2;
    $name = "{$max}_waldos";
    ...
    $waldoGame->save_image($base, '/var/www/html/whereswaldo2/scripts/test_output', $name);
    $waldoGame->color_waldo('waldo_camping_537x429.jpg',[214,24,52],[14,66,115],'waldo_camping_blue_537x429.jpg', '/var/www/html/whereswaldo2/waldo_images/');
}
